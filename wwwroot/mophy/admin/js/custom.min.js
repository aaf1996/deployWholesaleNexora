function getUrlParams(t) {
    var e, a, n = window.location.search.substring(1).split("&");
    for (a = 0; a < n.length; a++)
        if ((e = n[a].split("="))[0] === t) return void 0 === e[1] || decodeURIComponent(e[1])
}
var Mophy = function () {
    var t = $(window).width(),
        e = function () {
            jQuery(".default-select").length > 0 && jQuery(".default-select").selectpicker(), $("select").selectpicker()
        },
        a = function () {
        ...
        s = function () {
            jQuery("#ckeditor").length > 0 && ClassicEditor.create(document.querySelector("#ckeditor"), {
                simpleUpload: {
        ...
        v = function () {
            $(".dz-load-more").on("click", function (t) {
                t.preventDefault(), $(this).append(' <i class="fa fa-refresh"></i>');
                var e = $(this).attr("rel"),
                    a = $(this).attr("id");
                $.ajax({
                    method: "POST",
        ...
        b = function () {
            jQuery("#lightgallery").length > 0 && lightGallery(document.getElementById("lightgallery"), {
        ...
        C = function () {
            /*jQuery("body").append('<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global.js?btn_dir=right"></script>')*/
},
        z = function () {
            jQuery(".dz-demo-content").length, $(".dz-demo-trigger").on("click", function () {
        ...
        x = function () {
            jQuery(".bt-datepicker").length > 0 && $(".bt-datepicker").datepicker({
                autoclose: !0,
                todayHighlight: !0
    ...
    return {
        init: function () {
            a(), n(), o(), c(), i(), l(), d(), r(), u(), h(), p(), f(), m(), v(), g(), k(), b(), s(), z(), e(), y(), x()
        },
        load: function () {
            e(), a(), C()
        },
