...
ns('Mitosiz.Site.UI.Web.Components');
Mitosiz.Site.UI.Web.Components.Ajax = function (opts) {
    this.init(opts);
};

Mitosiz.Site.UI.Web.Components.Ajax.prototype = {
    ...
    init: function (opts) {
        ...
        if (opts) {
            ...
            this.timeout = typeof (opts.timeout) === 'undefined' ? this.timeout : opts.timeout;
            this.closeLoading = opts.closeLoading ? opts.closeLoading : true;
            if (this.autoSubmit) {
                this.submit();
            }
        }
    ...
    submit: function () {
        ...
        this.ajaxRequest.done(function (data) {
            if ((data != undefined) || me.dataType.toUpperCase() == 'HTML') {
                ...
                alert('Error al procesar la solicitud, el proceso retorno : IsSuccess="false"; Validar la ejecucion del proceso en el servidor. (AjaxUtil.ajaxRequest.done -> ' + data + ')');
            }
            me.data = null;
        });
        ...
        this.ajaxRequest.always(function (jqXHR, textStatus) {
            ...
            if (me.showLoading == true && me.loading != null && me.closeLoading) {
                me.loading.hide();
                me.loading = null;
            }
